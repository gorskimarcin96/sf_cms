...
final class Version20220412183536 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Added constant table.';
    }
...
<div>
<p style="text-align:justify">Posiadam ponad czteroletnie doświadczenie jako programista PHP. Skupiam się na technologiach backendowych. Pracowałem gł&oacute;wnie nad framework&#39;iem Symfony.&nbsp;Chcę pracować przy projektach, gdzie będziemy dbać o jakość kodu.</p>
<p>&nbsp;</p>
</div>
<table border="0" cellpadding="0" cellspacing="5" style="width:900px">
	<tbody>
		<tr>
			...
			<td>609 214 544</td>
			<td rowspan="6"><img alt="Marcin Górski" src="https://mgorski.dev/img/small_mgorski.jpg" style="float:right; height:200px; width:auto" /></td>
		</tr>
		<tr>
...
<table border="0" cellpadding="0" cellspacing="5" style="width:900px">
	<tbody>
		<tr>
			...
			<td>
			<ul>
				<li>backend: PHP, Symfony (1.4, 3-6), Laravel, PHPUnit, PHPStorm, MySQL,&nbsp;PostgreSQL, ElasticSearch</li>
...
<table border="0" cellpadding="0" cellspacing="5" style="width:900px">
	<tbody>
		<tr>
			<td style="width:270px"><strong>04.2022 &ndash; aktualnie</strong></td>
			<td>
			<p><strong>a-cube</strong></p>
			<p>Tworzenie api, integracja z KSeF.</p>
			<p><span style="font-size:20px">PHP 8.1, Symfony 5, api platform, PostgreSQL, docker, jira, bitbucket</span></p>
			</td>
		</tr>
		<tr>
			<td style="width:270px"><strong>07.2021 &ndash; 03.2022</strong></td>
			<td>
			<p><strong>Świat kwiat&oacute;w- Programista PHP</strong></p>
			<p>Przenoszenie legacy code do symfony 5.</p>
			<p><span style="font-size:20px">PHP 7.4, Symfony 5, MySQL, docker, jira, elasticsearch, cscart, smarty, gitlab</span></p>
			</td>
		</tr>
		<tr>
			...
			<p><span style="font-size:20px">PHP 7, Laravel, MySQL, bitbucket, docker, goglobal, idosell, phpunit, bootstrap 4</span></p>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<p><span style="font-size:20px">PHP 7, Symfony 3, MySQL, jQuery, ajax, css, bootstrap 3, api, gitlab, allegro, baselinker, ifirma, infact</span></p>
			<p>&nbsp;</p>
			</td>
		</tr>
		<tr>
			...
			<p><span style="font-size:20px">PHP 5.4/7&nbsp;Symofny 1.4, Symofny 3,&nbsp;MySQL, api, bootstrap 3, bitbucket</span></p>
			<p>&nbsp;</p>
			</td>
		</tr>
		<tr>
...
\');');
        ...
        $this->addSql('CREATE SEQUENCE constant_id_seq');
        $this->addSql('SELECT setval(\'constant_id_seq\', (SELECT MAX(id) FROM constant))');
        $this->addSql('ALTER TABLE constant ALTER id SET DEFAULT nextval(\'constant_id_seq\')');
    }
