 ...
 */
final class Version20210819180947 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create realization table';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE SEQUENCE realization_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('INSERT INTO public.realization (id, user_id, title, url, created_at, updated_at, file_fn) VALUES (1, 1, \'MGorski\', \'https://mgorski.dev/\', \'2021-08-19 18:13:32\', \'2021-08-19 18:13:32\', \'mgorski.png\');');
        $this->addSql('INSERT INTO public.realization (id, user_id, title, url, created_at, updated_at, file_fn) VALUES (2, 1, \'Psycholog Kraśnik\', \'http://www.psycholog-krasnik.pl/\', \'2021-08-19 18:14:20\', \'2021-08-19 18:14:20\', \'psychol.png\');');
    }
